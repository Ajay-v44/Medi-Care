    ...
    <div class="contact-w3l py-5" id="contact">
		<div class="container py-xl-5 py-lg-3">
			<div class="title-section mb-sm-5 mb-4">
				...
				<h3 class="w3ls-title text-uppercase text-bl font-weight-bold">SEARCH AMBULANCE</h3>
			</div>
                                            ...
                                            <table class="table table-bordered">
                                             ...
                                             <tr>
                                                    ...
                                                    <th style="background-color:lavender ">      
                                                        <span><label style="color: grey">Location</label></span>
                                                    </th>
                                                    <th>
                                             ...
                                             <tr>
                                                    ...
                                                    <th>
                                                       <span><input type="text" name="la" id="lat" class="form-control" required="required" /></span>
                                                    </th>
                                                 ...
                                                 <tr>
                                                    ...
                                                    <th>
                                                       <span><input type="text" name="lo" id="lng" class="form-control" required="required" /></span>
                                                    </th>
...
?>
            ...
            <div class="card hovercard">
                ...
                <div class="avatar">
                    <img alt="" src="img1/<?php echo $r_m1[7] ?>" width="500" height="500">
                </div>
                <div class="info">
                    <div class="title">
